...
function setup() {
  ...
  pendulum1 = new Pendulum(340, 250, "#00b0ff");
  ...
  sling1 = new Sling(pendulum1.body, { x: 240, y: 100 });
  sling2 = new Sling(pendulum2.body, { x: 300, y: 100 });
  sling3 = new Sling(pendulum3.body, { x: 360, y: 100 });
  sling4 = new Sling(pendulum4.body, { x: 420, y: 100 });
  sling5 = new Sling(pendulum5.body, { x: 480, y: 100 });
}
